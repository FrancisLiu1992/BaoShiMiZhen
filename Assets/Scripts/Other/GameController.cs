...
public class GameController : MonoBehaviour
{
    ...
    {
//		Debug.Log("+++++liukun recheck" + obj1 + "______" + obj2);
//		Debug.Log("+++++liukun recheck" + obj1.GetComponent<JewelObj>() + "______" + obj1.GetComponent<JewelObj>().jewel + "XXXXX" + obj1.GetComponent<JewelObj>().jewel.JewelPosition);
		Debug.Log("+++++liukun recheck" + obj1.name);
